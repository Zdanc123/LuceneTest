...
namespace LuceneTest.Controllers
{
    public class CharactersController : Controller
    {
        ...
        {
            LuceneService2.ClearLuceneIndex();
            var list = db.Characters.Include(che => che.CharacterEpisodes).ThenInclude(e => e.Episode).ToList();
                
            if (searchString != null && searchString != "")
            {
                LuceneService2.AddUpdateLuceneIndex(list);
                var result = LuceneService2.Search(searchString, "Id");
